      ...
      <div className="rounded-2xl bg-white p-6 shadow-sm">
        ...
        <div className="mb-6 flex items-start justify-between">
          <div>
            ...
            <p className="mt-0.5 text-sm text-gray-400">
              Create and manage blog articles and announcements
            </p>
          </div>
        ...
        <div className="mb-6 grid grid-cols-3 gap-3">
          {[
            ...
            { label: "Draft Posts", value: "12", icon: Edit, color: "text-amber-600 bg-amber-50" },
            {
              label: "Total Views",
              value: "48.2K",
              icon: Eye,
        ...
        <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-gray-200 py-20 text-center">
          ...
          <p className="max-w-sm text-sm text-gray-400">
            Rich text editor, categories, tags, scheduled publishing, and SEO settings.
          </p>
        </div>
      </div>
    </div>
