  ...
  return (
    <section className="rounded-lg border border-[#dce7f2] bg-white p-4">
      ...
      <p className="mb-3 text-xs text-[#90a3b6]">
        Review from this test list before saving or publishing
      </p>
      ...
      <div className="mt-3 grid gap-2 md:grid-cols-3">
        <div className="rounded-md border border-[#d6e5f4] bg-[#eaf2fb] p-2.5 text-xs text-[#4d93d9]">
          Linked Questions: 8
        </div>
        <div className="rounded-md border border-[#e4ddf4] bg-[#f1edfb] p-2.5 text-xs text-[#8468c4]">
          Linked Passages: 2
        </div>
        <div className="rounded-md border border-[#d5ece5] bg-[#e9f5f1] p-2.5 text-xs text-[#3b9b81]">
          Question Order Configured
        </div>
      </div>
